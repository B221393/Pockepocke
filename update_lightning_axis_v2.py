...
# 完璧な雷軸データの定義 (ポイント依存ダメージを実装)
updates = {
    "133": {"name": "イーブイ", "type": "Colorless", "hp": "60", "stage": "0", "attack1_name": "しっぽをふる", "attack1_cost": "1", "attack1_damage": "10"},
    "135": {"name": "サンダース", "type": "Lightning", "hp": "90", "stage": "1", "evolves_from": "イーブイ", "attack1_name": "スピード飛行", "attack1_cost": "2", "attack1_damage": "60", "attack1_effect": "point_proportional_damage_30"},
    "309": {"name": "ラクライ", "type": "Lightning", "hp": "60", "stage": "0", "attack1_name": "つきとめる", "attack1_cost": "1", "attack1_damage": "10"},
    "310": {"name": "ライボルト", "type": "Lightning", "hp": "90", "stage": "1", "evolves_from": "ラクライ", "attack1_name": "ライトニングブラスト", "attack1_cost": "2", "attack1_damage": "50", "attack1_effect": "point_proportional_damage_30"}
}
...
print("Manectric and Jolteon updated with POINT-SCALING damage.")
